...
const MainDashboardAjoutMenu = () => {
    ...
    const { isLoading: isUpdating, mutate, data: post } = useMutation( async (formData) => {
        await CreateMenu('extra-pizza3vdbboc', post)
    })
            ...
            <VStack color='#292D32' spacing='18px'>
                    ...
                    <HStack>
                        ...
                        <FormControl>
                            ...
                            <NumberInput min={2} max={6} step={1}>
                                <NumberInputField
                                    name='options.categories.limite'
                                    fontWeight='semibold'
                                    textAlign='center'
                                    bgColor='rgba(217, 217, 217, 0.79)'
                                    border='1px solid rgba(217, 217, 217, 0.37)'                   
                    ...
                    <HStack>
                        <FormControl>
                            ...
                            <Input name='options.categories.items.name' type='text' bgColor='rgba(217, 217, 217, 0.79)' border='1px solid rgba(217, 217, 217, 0.37)'/>
                        </FormControl>
                        <FormControl>
                            <FormLabel fontWeight='bold'>Ajouter un prix (facultatif)</FormLabel>
                            <NumberInput min={500} step={50}>
                                <NumberInputField
                                    name='options.categories.items.price' 
                                    fontWeight='semibold'
                                    textAlign='center'
                                    bgColor='rgba(217, 217, 217, 0.79)'
                                    border='1px solid rgba(217, 217, 217, 0.37)'                   
...
=======
                        <Input {...getInputProps()} name='medias' />
>>>>>>> 01259b277f07d905ab5875991a3ca3dffb9b43b7
                ...
                <Image src='/./assets/Chief.png' alt='' />
            </VStack>
        </HStack>
    </form>
  )
